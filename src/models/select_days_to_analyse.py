...
def excludeDaysInRange(days_to_analyse, start_date, end_date):
...
try:
    ...
    try:
        ...
        days_to_analyse = excludeDaysInRange(days_to_analyse, readmission1_date, readmission1_discharge)
    ...
    try:
        ...
        days_to_analyse = excludeDaysInRange(days_to_analyse, readmission2_date, readmission2_discharge)
    ...
    try:
        ...
        days_to_analyse = excludeDaysInRange(days_to_analyse, readmission3_date, readmission3_discharge)
